...
Installing Let’s Encrypt on your TurboStack server is quick and simple. The only requirement is that your hostname(s) correctly point to the server in DNS. For detailed setup instructions, click [here](/TurboStack%20Platform/Applications#creating-a-new-application-in-the-turbostack-platform).
...
If you’ve purchased a certificate from another provider, you can still install it easily on your TurboStack server through the Applications tab in [TurboStack.app](https://my.turbostack.app "TurboStack Platform"). More info on how to do so can be found [here](/TurboStack%20Platform/Applications#creating-a-new-application-in-the-turbostack-platform)
...
- Click **Applications**
- Click the **cog** of the application
...
Here we see the 'Issuer' of the certificate is Let's Encrypt, a valid certificate authority and also what is configured in [TurboStack.app](https://my.turbostack.app/ "TurboStack Platform") for this application (cert_type: letsencrypt). You can also usually verify this directly in the security fold-out, depending on browser:
...
- Assuming your domain points to your TurboStack server, check your application in [TurboStack.app](https://my.turbostack.app/ "TurboStack Platform") to make sure it's correctly configured as `letsencrypt`
